...
from ..types.score_retrieve_response import ScoreRetrieveResponse
...
class ScoreResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        Get a detailed score breakdown for a location, showing how each accessibility
        feature contributes to the overall score and verification confidence. Requires
